...
var productos_1 = __importDefault(require("../models/productos"));
...
var producto = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, productos_1.default.find({}).sort('nombre')];
                    case 1:
                        ProductoBD = _a.sent();
                        ...
                        return [4 /*yield*/, productos_1.default.countDocuments];
                    case 2:
                        conteo = _a.sent();
                        res.json({
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        idurl = req.params.id;
                        return [4 /*yield*/, productos_1.default.findById(idurl)];
                    case 1:
                        productoBD = _a.sent();
                        res.json({
                            ok: true,
    ...
    producto.prototype.postProducto = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var bodycabeceera, producto_1, productoBD, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        bodycabeceera = req.body;
                        producto_1 = new productos_1.default({
                        ...
                        return [4 /*yield*/, producto_1.save()];
                    case 1:
                        productoBD = _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
    ...
    producto.prototype.putProducto = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var idurl, bodycabecera, productoDB, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        ...
                        return [4 /*yield*/, productos_1.default.findByIdAndUpdate(idurl, bodycabecera, { new: true, runValidators: true, context: 'query' })];
                    case 1:
                        productoDB = _a.sent();
                        res.json({
                            producto: productoDB
    ...
    producto.prototype.deleteProducto = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var idurl, productoDB, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        idurl = req.params.id;
                        return [4 /*yield*/, productos_1.default.findByIdAndRemove(idurl)];
                    case 1:
                        productoDB = _a.sent();
                        res.json({
